...
namespace Bottles.Creation
{
    public class BottleCreator
    {
        ...
        public void CreateBottle(CreateBottleInput input, BottleManifest manifest)
        {
        ...
        private void writeZipFile(CreateBottleInput input, BottleManifest manifest, AssemblyFiles assemblies)
        {
            ...
            _zipFileService.CreateZipFile(zipFileName, zipFile =>
            {
                ...
                zipFile.AddFile(FileSystem.Combine(input.PackageFolder, BottleManifest.FILE), "");
        ...
        public void AddContentFiles(CreateBottleInput input, IZipFile zipFile, BottleManifest manifest)
        {
        ...
        public void AddDataFiles(CreateBottleInput input, IZipFile zipFile, BottleManifest manifest)
        {
            ...
            zipFile.AddFiles(new ZipFolderRequest()
                             {
                                 ...
                                 RootDirectory = Path.Combine(input.PackageFolder, CommonBottleFiles.DataFolder)
                             });
        }

        public void AddConfigFiles(CreateBottleInput input, IZipFile zipFile, BottleManifest manifest)
        {
            ...
            zipFile.AddFiles(new ZipFolderRequest(){
                ...
                RootDirectory = input.PackageFolder,
                ZipDirectory = CommonBottleFiles.ConfigFolder
            });
        }
