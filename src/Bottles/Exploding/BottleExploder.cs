...
namespace Bottles.Exploding
{
    ...
    {
        public static BottleExploder GetBottleExploder(IFileSystem fileSystem)
        {
        ...
        public static BottleExploder GetBottleExploder(IBottleLog log)
        {
        ...
        public IEnumerable<string> ExplodeAllZipsAndReturnPackageDirectories(string applicationDirectory, IBottleLog log)
        {
            ...
            return ExplodeDirectory(new ExplodeDirectory(){
                DestinationDirectory = CommonBottleFiles.GetExplodedPackagesDirectory(applicationDirectory),
                PackageDirectory = CommonBottleFiles.GetApplicationPackagesDirectory(applicationDirectory),
                Log = log
            });
        }
        ...
        //destinationDirectory = var directoryName = CommonBottleFiles.DirectoryForPackageZipFile(applicationDirectory, sourceZipFile);
        ...
        public void CleanAll(string applicationDirectory)
        {
            ...
            var directory = CommonBottleFiles.GetExplodedPackagesDirectory(applicationDirectory);
            ...
            clearExplodedDirectories(CommonBottleFiles.GetApplicationPackagesDirectory(applicationDirectory));
        }
        ...
        public void ExplodeAssembly(string applicationDirectory, Assembly assembly, IBottleFiles files)
        {
            var directory = CommonBottleFiles.GetDirectoryForExplodedPackage(applicationDirectory, assembly.GetName().Name);
        ...
        private void explodeAssembly(Assembly assembly, string directory)
        {
            ...
            assembly.GetManifestResourceNames().Where(CommonBottleFiles.IsEmbeddedPackageZipFile).Each(name =>
            {
                var folderName = CommonBottleFiles.EmbeddedPackageFolderName(name);
                ...
                _fileSystem.WriteStringToFile(FileSystem.Combine(directory, CommonBottleFiles.VersionFile), version);
            });
        }
