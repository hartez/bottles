...
namespace Bottles
{
    ...
    public class BottleManifest
    {
        ...
        {
            return string.Format("Bottle: {0}", Name);
        }
        ...
        public void AddDependency(string bottleName, bool isMandatory)
        {
            _dependencies.RemoveAll(x => x.Name == bottleName);
