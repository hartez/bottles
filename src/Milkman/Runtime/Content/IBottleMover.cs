...
namespace Bottles.Deployment.Runtime.Content
{
    ...
    public class BottleMover : IBottleMover
    {
        ...
        private IList<BottleExplosionRequest> getExplosionRequests(IBottleLog log, IEnumerable<BottleManifest> manifests, IBottleDestination destination)
        {
    ...
    {
        IEnumerable<BottleExplosionRequest> DetermineExplosionRequests(BottleManifest manifest);
    }
