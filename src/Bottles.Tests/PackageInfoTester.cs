...
namespace Bottles.Tests
{
    ...
    public class PackageInfoTester
    {
        ...
        public void SetUp()
        {
            ...
            _theBottle = new BottleInfo("something");
            _theBottle.RegisterFolder(CommonBottleFiles.DataFolder, Path.GetFullPath(theDataFolder));
        }
        ...
        public void add_dependency_returns_later()
        {
            ...
            _theBottle.As<IBottleInfo>().GetDependencies()
        ...
        public IEnumerable<string> readFiles(string searchString)
        {
            ...
            ((IBottleInfo)_theBottle).ForData(searchString, (name, stream) => list.Add(stream.ReadAllText()));
        ...
        {
            ((IBottleInfo)_theBottle).ForData(join("nonexistent", "*.xml"), (x, y) => Assert.Fail("Not supposed to call this"));
        }
        ...
        public void get_the_file_names()
        {
            ...
            var list = new List<string>();
            ((IBottleInfo)_theBottle).ForData("*.*", (name, stream) => list.Add(name));
